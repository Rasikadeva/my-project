...
const cnvsCustomizer = () => {
    ...
    if (cnvsSwitcherFileName.startsWith("demo-")) {
        ...
        SEMICOLON.Core.loadCSS({
            file: "css/preview-styles.css",
            id: "cnvs-preview-styles"
        });
    }
    ...
    cnvsSwitcherPreloaders.forEach(el => {
        el.onclick = e => {
            ...
            let elLoader = el.getAttribute('data-loader'),
                elLoaderAppend, pageTransition = document.querySelector('.page-transition-wrap');
            if (elLoader == '2') {
    ...
    cnvsSwitcherPrimaryFont.addEventListener('change', () => {
        ...
        if (cnvsSwitcherPrimaryFont.value) {
            ...
            SEMICOLON.Core.loadCSS({
                file: 'https://fonts.googleapis.com/css2?family=' + fontProps[0] + '&display=swap',
                id: fontID
            });
...
var cnvsTips = [{
    "title": "Random Tips",
    "content": "This is a Random Tips Element. You can style this as you want.",
    "page": "*"
}, {
    "title": "Did you know?",
    "content": "You can enable Page Transition across the Website by simply enabling this option to <strong>true</strong> in the JS File.",
    "page": "*"
}, {
    "title": "Looking for Form Auto-Responders?",
    "content": "Canvas includes Auto-Responders for Forms which are personlization enabled.",
    "page": "*"
}, {
    "title": "Anywhere Mobile-Menus!",
    "content": "Enable Mobile Menus on any Device Width by defining a Custom Menu Breakpoint.",
    "page": "*"
}, {
    "title": "SPAM Protection",
    "content": "Canvas's Forms comes with multiple layers of SPAM Protection like Bot Detection, reCaptcha, hCaptcha or SPAM Word detection.",
    "page": "*"
}, {
    "title": "Powerful CSS Variables",
    "content": "Canvas is built using powerful CSS Variables across the Stylesheet. Easily Customize each and every part of your Website with just a handful of codes. No overwrites and bloated Custom CSS Codes.",
    "page": "*"
}, {
    "title": "Dark-Mode on Demand",
    "content": "Enable Dark Mode for any Section/Element on any Page using Our Powerful <a href='https://docs.semicolonweb.com/docs/utility-classes/contrast/' target='_blank'>Contrast Utility Classes</a>.",
    "page": "*"
}, {
    "title": "Powerful Form Processor",
    "content": "Convert any Form into a Working Email Form. No need to edit any Backend Codes. Just add your Form Fields and that's enough!",
    "page": "*"
}, {
    "title": "<i class='bi-lightning-charge me-1'></i> Supreme Page Performance!",
    "content": "Canvas comes with Async JS Lazy Loading which makes the Pages load Super Fast! Check the <a href='https://pagespeed.web.dev/report?url=https%3A%2F%2Fcanvastemplate.com%2Fdemo-app-landing.html&form_factor=desktop' target='_blank'>Google Page Speed</a> on our Live Demos with Async JS Enabled.",
    "page": "*"
}, {
    "title": "Unlimited &amp; Easy Colors Management",
    "content": "Change the Color Scheme of your Website with just one line of code.",
    "page": "*"
}, {
    "title": "RTL Compatibility",
    "content": "Take advantage of the Right-To-Left Languages compatibility out of the box for your Middle-East Customers &amp; increase your Website's footprint.",
    "page": "*"
}, {
    "title": "<i class='fa-solid fa-infinity me-1'></i> Infinite Header Layouts",
    "content": "Utilize the Power of Flex Grid &amp; you can create any Header Layout you can imagine.",
    "page": "*"
}, {
    "title": "Anywhere Sticky Headers",
    "content": "Headers are sticky on all Layouts whether Desktops or Mobile Devices. Just a single Line of Code and you are all set.",
    "page": "*"
}, {
    "title": "Updates are always FREE",
    "content": "Canvas is a one-time Purchase. You Purchase it once and your Website is set for Lifetime including FREE Updates.",
    "page": "*"
}, {
    "title": "Mobile Friendly Parallax",
    "content": "Parallax Sections included with Canvas are completely Mobile Friendly &amp; uses Vanilla JS. No External Plugins! So Super Light on the Page.",
    "page": "*"
}, {
    "title": "Premium Scroll Animations",
    "content": "Canvas includes Premium Scroll Interations &amp; Animations that piques users interest in your Website and increase conversions.",
    "page": "*"
}, ];
